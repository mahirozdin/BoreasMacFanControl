...
- **Genel durum:** P0–P2 tamam, P3 yarılandı. Ayrıcalıklı yardımcı yazıldı, imzalandı ve uygulama paketine gömüldü; XPC yüzeyi dört metotla sınırlı ve kapıyla korunuyor. **Kalan tek adım kök daemon'un fiilen kaydedilmesi — proje sahibinin onayı bekleniyor.** 77 test, 9 kapı.
...
| P3 | `IN_PROGRESS` | Ayrıcalık katmanı ve daemon | **P3.00 — kayıt denemesi (onay bekliyor)** |
