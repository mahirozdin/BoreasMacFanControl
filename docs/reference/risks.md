...
| **R10** | Translation staleness — 5 languages, a single developer | High | Low | A missing translation falls back to the source language, never showing blank; the CI warning does not block a release; `TRANSLATORS.md`; documentation is deliberately outside translation scope. [ADR 0016](../architecture/adr/0016-language-scope.md) | Community |
